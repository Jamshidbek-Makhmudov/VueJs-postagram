...
const store = createStore({
    state: {}, //state bizdagi xolatlar
    mutations: {}, // mutations qilinaduigan ozgarishlar ya'ni actionlar
    ...
    actions: {}, //actionslar mutationslar bilan deyarli bir xil farqi, stateni mutation qilishorniga commit qiladi
    ...
    modules: { auth, articles, control }, //modul nimaga kerak? bizda katta projectlarda stat va mutationl;ar juda kopayib ketadi modula shularni guruhlarga bolib sartirovka qilib beradi
